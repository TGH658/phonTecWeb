...
const zhText = {
  ...
  statTeam:'位团队<br>成员',
  libraryKicker:'HEALING UPDATES', libraryTitleA:'疗愈动态', libraryTitleB:'', libraryDesc:'汇集论文成果、疗愈实践与竞赛项目，点击缩略图进入完整内容。', libraryCountLabel:'项内容', libraryAuto:'AUTO SCROLL · 4.3秒自动切换',
  ...
  libraryHistoryItem1:'古典园林与私密活动', libraryHistoryItem2:'榕湖景观提升项目', libraryHistoryItem3:'像素绿洲', libraryHistoryItem4:'桂林滨水公共空间恢复性效应与感知偏好', libraryHistoryItem5:'花笺寄情，春日抚心', libraryHistoryItem6:'榕湖｜叠彩疗愈工坊体验', libraryHistoryItem7:'',
...
const zhHantText = {
  ...
  statTeam:'位團隊<br>成員',
  libraryKicker:'HEALING UPDATES', libraryTitleA:'療癒動態', libraryTitleB:'', libraryDesc:'匯集論文成果、療癒實踐與競賽項目，點擊縮略圖進入完整內容。', libraryCountLabel:'項內容', libraryAuto:'AUTO SCROLL · 4.3秒自動切換',
  ...
  libraryHistoryItem1:'古典園林與私密活動', libraryHistoryItem2:'榕湖景觀提升項目', libraryHistoryItem3:'像素綠洲', libraryHistoryItem4:'桂林濱水公共空間恢復性效應與感知偏好', libraryHistoryItem5:'花箋寄情，春日撫心', libraryHistoryItem6:'榕湖｜疊彩療癒工坊體驗', libraryHistoryItem7:'',
...
const enText = {
  ...
  paperCountLabel:'papers and research outputs', readerNote:'Tap a card for the paper page, then tap again to open the full text. Read page by page and pinch to zoom.',
...
const builtProjects = [
  {
    ...
    kicker:'RONGHU HOTEL · LIYUN SHANJING',
    titleZh:'榕湖饭店“漓韵山景”景观提升',
    titleHant:'榕湖飯店「漓韻山景」景觀提升',
    titleEn:'Ronghu Hotel · Liyun Shanjing Landscape Enhancement',
    descZh:'项目针对榕湖饭店园林中既有出地面楼梯间与泄爆口进行景观化更新。项目页按照“施工前现状—建成效果—平面技术图”的顺序，呈现既有工程设施如何通过新的景观界面重新融入酒店园林环境。',
    descHant:'項目針對榕湖飯店園林中既有出地面樓梯間與洩爆口進行景觀化更新。項目頁按照「施工前現狀—建成效果—平面技術圖」的順序呈現。',
    descEn:'The project upgrades existing stair and pressure-relief structures at Ronghu Hotel. The page is organized as existing condition, completed views and technical plans.',
    tagZh:'景观改造 · 建成效果 · 技术图纸',
    tagHant:'景觀改造 · 建成效果 · 技術圖紙',
    tagEn:'LANDSCAPE RENOVATION · COMPLETED · DRAWINGS',
    coverImage:'assets/projects/ronghu/01.webp',
    captionsZh:[
      '施工前现状：楼梯间、泄爆口等工程体量直接暴露于园林环境',
      '完成效果图：入口界面与园林背景的整体呈现',
      '完成效果图：曲线竖向格栅围合既有设施并形成识别性的入口',
      '完成效果图：线性界面与竹植景观共同构成连续的场地边界',
      '完成效果图：从酒店入口望向更新后的“漓韵山景”园林界面',
      '技术平面图：20#楼梯 ±0.00 标高平面图 / 1:50',
      '技术平面图：2#楼梯 ±0.00 标高平面图 / 1:50',
      '技术平面图：出地面楼梯间及泄爆口平面图'
    ],
    captionsHant:[
      '施工前現狀',
      ...
      '完成效果圖：曲線豎向格柵與入口',
      '完成效果圖：連續邊界與竹植景觀',
      '完成效果圖：酒店入口望向更新後的園林界面',
      '技術平面圖：20#樓梯 ±0.00 標高平面圖 / 1:50',
      '技術平面圖：2#樓梯 ±0.00 標高平面圖 / 1:50',
      '技術平面圖：出地面樓梯間及洩爆口平面圖'
    ],
    captionsEn:[
      'Existing condition before renovation',
      'Completed view: entry interface in the garden setting',
      'Completed view: curved vertical fins and identifiable entrance',
      'Completed view: continuous edge with bamboo planting',
      'Completed view: renewed garden interface seen from the hotel entry',
      'Technical plan: Stair 20 / Level ±0.00 / 1:50',
      'Technical plan: Stair 2 / Level ±0.00 / 1:50',
      'Technical plan: stair and pressure-relief structures'
    ],
    images:[
      'assets/projects/ronghu/editorial/00-before.webp',
      'assets/projects/ronghu/01.webp',
      'assets/projects/ronghu/02.webp',
      'assets/projects/ronghu/03.webp',
      'assets/projects/ronghu/05.webp',
      'assets/projects/ronghu/editorial/11-plan-20-stair.webp',
      'assets/projects/ronghu/editorial/12-plan-02-stair.webp',
      'assets/projects/ronghu/editorial/13-plan-stair-relief.webp'
    ]
  },
  {
    index:'02',
    slug:'feifeng-pet-healing-classroom',
    kicker:'FEIFENG PRIMARY SCHOOL · CAT-YU SENJING',
    titleZh:'飞凤小学宠物疗愈教室设计',
    titleHant:'飛鳳小學寵物療癒教室設計',
    titleEn:'Feifeng Primary School Pet-Assisted Healing Classroom',
    descZh:'由普通小学教室改造而来的宠物友好型疗愈空间。项目以“猫语森境”为主题，将阅读、围坐、自然体验与宠物观察整合到同一教室，通过轻自然色系、仿生构件与透明观察边界，建立儿童、教师与宠物之间安全、可观察、可参与的日常关系。',
    descHant:'由普通小學教室改造而來的寵物友好型療癒空間。項目以「貓語森境」為主題，整合閱讀、圍坐、自然體驗與寵物觀察。',
    descEn:'A conventional primary-school classroom transformed into a pet-friendly healing environment integrating reading, group activity, nature experience and animal observation.',
    tagZh:'校园疗愈 · 室内改造',
    tagHant:'校園療癒 · 室內改造',
    tagEn:'CAMPUS HEALING · INTERIOR RENOVATION',
    coverImage:'assets/projects/feifeng/editorial/06-completed-hero.webp',
    captionsZh:[
      '施工前现状：普通教室以成排课桌和单一课堂教学为主',
      '施工前现状：窗边自然采光充足，但缺少可停留、可观察和可退避的多层次空间',
      '方案过程：以“猫语森境”为主题，将仿生造型与轻自然色系引入教室',
      '方案过程：阅读、围坐、观察与宠物友好空间被组织为连续场景',
      '方案过程：原木、暖白、浅绿和浅灰构成低刺激的环境基调',
      '完成空间：阅读、微景观活动与宠物观察进入日常使用场景',
      '完成空间：透明边界保证动物可被观察，同时维持安全与管理',
      '完成空间：儿童与教师在阅读、手作和自然体验中形成柔和互动',
      '技术图纸：空间应用轴测与自然联结设计策略',
      '技术图纸：宠物疗愈教室平面图'
    ],
    captionsHant:[
      '施工前現狀','施工前現狀',
    ...
    captionsEn:[
      ...
      'Design process: Cat-Yu Senjing','Design process','Design process',
      'Completed space','Completed space','Completed space',
      'Technical drawing: spatial applications and nature-connection strategies',
      'Technical drawing: classroom plan'
    ],
    images:[
      'assets/projects/feifeng/editorial/00-before-01.webp',
      'assets/projects/feifeng/editorial/01-before-02.webp',
      'assets/projects/feifeng/02.webp',
      'assets/projects/feifeng/03.webp',
      'assets/projects/feifeng/04.webp',
      'assets/projects/feifeng/editorial/06-completed-hero.webp',
      'assets/projects/feifeng/01.webp',
      'assets/projects/feifeng/05.webp',
      'assets/projects/feifeng/editorial/10-spatial-applications.webp',
      'assets/projects/feifeng/editorial/11-classroom-plan.webp'
    ]
  },
  {
    index:'03',
...
const projectEditorialData = {
  'ronghu-landscape':{
    year:'2026',
    locationZh:'中国 · 桂林 · 榕湖饭店',locationHant:'中國 · 桂林 · 榕湖飯店',locationEn:'Ronghu Hotel, Guilin, China',
    statusZh:'已建成 · 景观提升',statusHant:'已建成 · 景觀提升',statusEn:'Completed · Landscape Enhancement',
    factsZh:[
      ['设计主题','漓韵山景'],
      ['内容结构','施工前现状 / 建成效果 / 平面技术图']
    ],
    factsHant:[
      ['設計主題','漓韻山景'],
      ['內容結構','施工前現狀 / 建成效果 / 平面技術圖']
    ],
    factsEn:[
      ['Design Theme','Liyun Shanjing'],
      ['Page Structure','Existing condition / Completed views / Plans']
    ],
    sectionsZh:[
      {insertAt:0,title:'01｜施工前现状',body:'改造前，出地面楼梯间与泄爆口以相对独立的工程体量直接暴露在园林环境中，与周边道路、绿地及酒店园林界面之间缺少连续关系。现状图作为项目的起点，用于说明景观化更新需要回应的工程条件与场地背景。'},
      {insertAt:1,title:'02｜建成效果',body:'更新完成后，竖向构件、入口轮廓与植物配置共同形成连续的景观界面。不同视角下的建成照片展示了构筑物如何弱化原有工程体量，并在道路转角、酒店入口和园林背景之间建立更统一的空间关系。'},
      {insertAt:5,title:'03｜平面技术图',body:'三张平面图分别对应20#楼梯、2#楼梯以及出地面楼梯间与泄爆口，重点呈现构筑物边界、出入口、通行与维护空间，以及其与周边场地关系的技术控制。'}
    ],
    sectionsEn:[
      {insertAt:0,title:'01 | Existing condition',body:'The existing stair and pressure-relief structures appeared as isolated engineering volumes in the garden setting.'},
      {insertAt:1,title:'02 | Completed views',body:'Completed photographs show how the new vertical interface, entrances and planting integrate the structures into the surrounding garden and hotel context.'},
      {insertAt:5,title:'03 | Technical plans',body:'Three plans document the spatial relationship among structure boundaries, access, maintenance zones and the surrounding site.'}
    ]
  },
  'feifeng-pet-healing-classroom':{
    year:'2026',
    locationZh:'中国 · 桂林 · 飞凤小学',locationHant:'中國 · 桂林 · 飛鳳小學',locationEn:'Feifeng Primary School, Guilin, China',
    statusZh:'已完成 · 校园疗愈空间改造',statusHant:'已完成 · 校園療癒空間改造',statusEn:'Completed · Campus Healing Interior',
    factsZh:[
      ['设计主题','猫语森境'],
      ['设计单位','桂林理工大学刘韩昕教授工作室'],
      ['设计人员','刘韩昕 / 何霁芸 / 黄田志磊'],
    ...
    factsEn:[
      ['Theme','Cat-Yu Senjing'],
      ['Design Studio','Hanxin Liu Studio · Guilin University of Technology'],
      ['Designers','Hanxin Liu / Jiyun He / Tianzhilei Huang'],
      ['Completion','2026.07.08']
    ],
    sectionsZh:[
      {insertAt:0,title:'01｜改造前：一间典型小学教室',body:'原空间以成排课桌、黑板、吊灯和吊扇构成标准课堂秩序。连续外窗带来良好的自然采光，但活动模式单一，缺少阅读、围坐、安静观察与宠物互动所需要的多层次空间。改造的第一步不是增加装饰，而是重新分配儿童活动、教师照护和宠物观察之间的关系。'},
      {insertAt:2,title:'02｜方案过程：从课堂秩序到“猫语森境”',body:'设计以“猫语森境”为主题，将猫耳、猫爪和树冠等柔和形态转化为空间语言，并以原木、暖白、浅绿和浅灰建立低刺激的环境基调。阅读台阶、组合桌、展示墙和透明观察界面共同形成可学习、可停留、可观察的连续场景。'},
      {insertAt:5,title:'03｜完成空间：让疗愈进入日常使用',body:'完成后的空间不把疗愈设定为独立活动，而是嵌入阅读、手作、围坐和宠物观察等日常行为。开放的中心区域支持集体活动，边缘的阅读与观察位置提供更安静的停留选择；透明隔断在保持视觉联系的同时，也为动物活动和教师管理建立清晰边界。'},
      {insertAt:8,title:'04｜技术图纸：空间策略与平面落位',body:'项目最后以两张技术图收束：空间应用轴测将自然光、植物、仿生形态、展望—庇护和宠物观察等策略对应到具体构件；平面图进一步落实阅读、活动、观察、储藏与宠物区域之间的关系，使设计概念转化为可使用、可管理的空间系统。'}
    ],
    sectionsEn:[
      {insertAt:0,title:'01 | Before: a conventional classroom',body:'Rows of desks, blackboards and suspended fixtures defined a single teaching mode. Good daylight existed, but the room lacked spaces for reading, retreat, observation and animal-friendly activity.'},
      {insertAt:2,title:'02 | Design process: Cat-Yu Senjing',body:'Soft biomorphic cues, timber, warm white and pale green reorganize the classroom into connected settings for reading, gathering, observation and pet-friendly use.'},
      {insertAt:5,title:'03 | Completed space: healing in everyday use',body:'Restorative experience is embedded in ordinary reading, making, gathering and animal observation, with transparent boundaries balancing visual contact, management and animal welfare.'},
      {insertAt:8,title:'04 | Technical drawings',body:'An exploded spatial-application drawing and the classroom plan connect nature-connection strategies with the final organization of reading, activity, observation, storage and pet zones.'}
    ]
  },
...
const teamMembers = [
  ...
  {nameZh:'郝婉汀',nameEn:'Wanting Hao',degreeZh:'桂林理工大学2026级风景园林在读研究生',degreeHant:'桂林理工大學2026級風景園林在讀研究生',degreeEn:'2026 graduate student in Landscape Architecture, Guilin University of Technology',image:'assets/team/hao-wanting.webp'},
...
function renderProjectArticle(project){
  projectShowcase.dataset.projectSlug = project.slug;
  ...
  const sectionIndexes = new Map();
  sections.forEach((section,index)=>{
    const automatic = sections.length === 1 ? 0 : Math.round(index * Math.max(1,project.images.length-1) / Math.max(1,sections.length-1));
    const insertion = Number.isInteger(section.insertAt) ? Math.max(0,Math.min(project.images.length-1,section.insertAt)) : automatic;
    if (!sectionIndexes.has(insertion)) sectionIndexes.set(insertion,[]);
    sectionIndexes.get(insertion).push({section,index});
  });
  const storyMarkup = (section,index)=>`
  ...
  const projectFacts = usesTraditionalContent() ? (info.factsHant || info.factsZh || []) : (usesChineseContent() ? (info.factsZh || []) : (info.factsEn || []));
  projectTechnical.innerHTML = `
    ...
    <dl>
      ...
      ${projectFacts.map(item=>`<div><dt>${item[0]}</dt><dd>${item[1]}</dd></div>`).join('')}
    </dl>
  `;
...
/* R7 · desktop navigation state */
(()=>{
  const links = [...document.querySelectorAll('.desktop-nav [data-desktop-nav]')];
  if (!links.length) return;
  const sections = ['news','papers','projects','team']
    .map(id=>document.getElementById(id))
    .filter(Boolean);
  const setActive = id=>{
    links.forEach(link=>link.classList.toggle('active',link.dataset.desktopNav===id));
  };
  links.forEach(link=>{
    link.addEventListener('click',()=>{
      setActive(link.dataset.desktopNav);
    });
  });
  if ('IntersectionObserver' in window){
    const observer = new IntersectionObserver(entries=>{
    ...
    },{root:null,rootMargin:'-22% 0px -58% 0px',threshold:[0,.08,.2,.45]});
